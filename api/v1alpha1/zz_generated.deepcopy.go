...
func (in *ProbeSpec) DeepCopyInto(out *ProbeSpec) {
	*out = *in
	...
	out.SlackDetails = in.SlackDetails
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResolveFromSecret) DeepCopyInto(out *ResolveFromSecret) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResolveFromSecret.
func (in *ResolveFromSecret) DeepCopy() *ResolveFromSecret {
	if in == nil {
		return nil
	}
	out := new(ResolveFromSecret)
	in.DeepCopyInto(out)
	return out
}
